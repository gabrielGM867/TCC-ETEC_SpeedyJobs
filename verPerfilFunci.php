...
<head>
	...
	<title><?php echo $_SESSION["nome_usuarioFunci"]; ?></title>
    ...
    <link href="css/estiloVerPerfilFunci.css" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg navbar-light ">
    ...
    <div class="btn-success" >
        <a href="#openModalEdicao">Editar Perfil</a>  
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="info"> 
        <div class="form-signin">
            ...
            $lista = mysqli_query($con, "Select tbfuncionarios.foto, tbfuncionarios.nome, 
			tbfuncionarios.profissao, tbfuncionarios.nomeUsuario, tbfuncionarios.email, 
			tbfuncionarios.dataNascimento, tbfuncionarios.sexo, tbfuncionarios.classificacao, 
			tbenderecofuncionario.cep, tbenderecofuncionario.rua, tbenderecofuncionario.bairro, 
			tbenderecofuncionario.cidade, tbenderecofuncionario.estado, tbtelefonesfuncionario.numero 
			from `tbfuncionarios` 
    ...
    <div class="fotos">
        ...
        <?php
            ...
            WHERE tbfuncionarios.codigo = '$codigoo' ORDER BY `codiFoto` DESC LIMIT 25");

            if(mysqli_num_rows($lista) < 1){
                echo " Você não postou nenhuma foto de serviço ainda.";
            }
...
<div class="pull-right">
    <a href="#openModalPostar" class="scrollup" title="Postar Foto de Serviços">+</a>

     <div id="openModalPostar" class="modalDialog">
            <div>
                <a href="#close" title="Fechar" class="closeModal"></a>
                <h2>Postar Foto de Serviços</h2>
                    <div class="textos">
                        <form name="formFoto2" method="post" enctype="multipart/form-data" 
                        action="php/postarFoto.act.php" onsubmit="return validar_formFoto2(this)">

                        <label for="campo_foto2">Foto:</label>
                        <input type="file" name="input_foto2" id="campo_foto2" /><br />

                        <div id="alertFotoVazio2">
                            <footer class="alert">
            ...
            <div>
                ...
                <h2>Alterar Foto de Capa</h2>
                    <div class="textos">
                        ...
                        action="php/alterarFotoCapaFunci.act.php" onsubmit="return validar_formFotoCapa(this)">
        	...
        	<div>
        		...
        		<h2>Alterar Foto</h2>
        			<div class="textos">
        				...
        				action="php/alterarFotoFunci.act.php" onsubmit="return validar_formFoto(this)">
        	...
        	<div>
        		...
        		<h2>Alterar Nome</h2>
        			<div class="textos">
        				...
        				action="php/alterarNomeFunci.act.php" onsubmit="return validar_formNome(this)">
        	...
        	<div>
        		...
        		<h2>Alterar E-mail</h2>
        			<div class="textos">
        				...
        				action="php/alterarEmailFunci.act.php" onsubmit="return validar_formEmail(this)">
        	...
        	<div>
        		...
        		<h2>Alterar Data de nascimento</h2>
        			<div class="textos">
        				...
        				action="php/alterarDataFunci.act.php" onsubmit="return validar_formData(this)">
        	...
        	<div>
        		...
        		<h2>Alterar Sexo</h2>
        			<div class="textos">
        				...
        				action="php/alterarSexoFunci.act.php" onsubmit="return validar_formSexo(this)">
        	...
        	<div>
        		...
        		<h2>Alterar Número</h2>
        			<div class="textos">
        				...
        				action="php/alterarTelefoneFunci.act.php" onsubmit="return validar_formNum(this)">
        	...
        	<div>
        		...
        		<h2>Alterar Endereço</h2>
        			<div class="textos">
        				...
        				action="php/alterarEnderecoFunci.act.php" onsubmit="return validar_formCEP(this)">
        	...
        	<div>
        		...
        		<h2>Alterar Senha</h2>
        			<div class="textos">
        				...
        				action="php/alterarSenhaFunci.act.php" onsubmit="return validar_formSenha(this)">
        	            ...
        	            <input type="password" name="confirmSenha" title="Confirme sua senha" placeholder="Confirme Senha"/><br />
