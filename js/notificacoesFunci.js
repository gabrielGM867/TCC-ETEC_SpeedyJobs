//NOTIFICAÇOES DE Negociação
    document.addEventListener('DOMContentLoaded', function(){
        ...
        window.setInterval(function(){
            xhr.get('php/notificacoesFecharNegocio.php?acao=verificar', function(total){
                total_not.innerHTML = total;
            });
        }, 5000);

        window.setInterval(function(){
            xhr.get('php/notificacoesFecharNegocio.php?acao=getnots', function(nots){
                res.innerHTML = nots;
            });
        }, 5000);
...
//NOTIFICAÇOES DE MENSAGENS
    document.addEventListener('DOMContentLoaded', function(){
        ...
        window.setInterval(function(){
            xhr.get('php/notificacoesMensagensFunci.php?acao=verificar', function(total){
                total_not.innerHTML = total;
            });
        }, 5000);

        window.setInterval(function(){
            xhr.get('php/notificacoesMensagensFunci.php?acao=getnots', function(nots){
                res.innerHTML = nots;
            });
        }, 5000);
